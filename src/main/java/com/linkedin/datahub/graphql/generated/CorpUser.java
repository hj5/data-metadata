...
public class CorpUser implements java.io.Serializable, OwnerType, Entity {
    ...
    public CorpUser(String urn, EntityType type, String username, CorpUserProperties properties, CorpUserEditableProperties editableProperties, CorpUserStatus status, GlobalTags tags, Boolean isNativeUser, CorpUserInfo info, CorpUserEditableInfo editableInfo, GlobalTags globalTags) {
        this.urn = urn;
        this.type = type;
...
The structured tags associated with the user
        ...
        public CorpUser build() {
            return new CorpUser(urn, type, username, properties, editableProperties, status, tags, isNativeUser, info, editableInfo, globalTags);
        }
