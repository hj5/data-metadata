...
public class GlossaryTermInfo implements java.io.Serializable {
    ...
    public GlossaryTermInfo(String name, String description, String definition, String termSource, String sourceRef, String sourceUrl, java.util.List<StringMapEntry> customProperties, String rawSchema) {
        this.name = name;
