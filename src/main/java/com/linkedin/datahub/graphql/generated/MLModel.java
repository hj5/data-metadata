...
The standard tags for the ML Model
        ...
        public MLModel build() {
            return new MLModel(urn, type, name, platform, origin, description, globalTags, tags, ownership, properties, intendedUse, factorPrompts, metrics, evaluationData, trainingData, quantitativeAnalyses, ethicalConsiderations, caveatsAndRecommendations, institutionalMemory, sourceCode, status, cost, deprecation, dataPlatformInstance, glossaryTerms, domain, editableProperties);
        }
