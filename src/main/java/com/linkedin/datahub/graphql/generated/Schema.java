...
public class Schema implements java.io.Serializable {
    ...
    public Schema(String datasetUrn, String name, String platformUrn, Long version, String cluster, String hash, PlatformSchema platformSchema, java.util.List<SchemaField> fields, java.util.List<String> primaryKeys, java.util.List<ForeignKeyConstraint> foreignKeys, Long createdAt) {
    ...
    public static class Builder {
        ...
        public Schema build() {
            return new Schema(datasetUrn, name, platformUrn, version, cluster, hash, platformSchema, fields, primaryKeys, foreignKeys, createdAt);
        }
