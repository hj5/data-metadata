...
public class SearchAcrossLineageResults implements java.io.Serializable {
    ...
    public SearchAcrossLineageResults(int start, int count, int total, java.util.List<SearchAcrossLineageResult> searchResults, java.util.List<FacetMetadata> facets) {
        this.start = start;
        this.count = count;
        this.total = total;
    ...
    public static class Builder {
        ...
        public SearchAcrossLineageResults build() {
            return new SearchAcrossLineageResults(start, count, total, searchResults, facets);
        }
